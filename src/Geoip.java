...
public class Geoip {
    ...
    private HashMap<Integer,Location> data = new HashMap<Integer, Location>(); 
    ...
    {
        if (word == null) {
            System.out.println("invalid parameter workd: should not be null");
            return null;
        }
        char[] w = word.toCharArray();
        Vertex node = root;
    ...
    public void loadData(String path, String location_filename, String block_filename) throws Exception
    {
        try {
            ...
            System.out.println("load csv exception: " + e.toString());
    ...
    public void loadBlocks(String filename) throws Exception
    {
        ...
        while ((line = reader.readLine()) != null) {
            ...
            if (network == null) {
                System.out.println("network: " + ip + ", invalid network binary, should not be null");
                continue;
            }
            Location location = data.get(geoname_id);
            if (location == null) {
                System.out.println("network: " + ip + ", geoname_id: " + geoname_id + " have no correspondingly locations");
                continue;
            }
    ...
    public static void main(String args[])
    {
        try {
            ...
            geo.loadData("/tmp", "GeoLite2-City-Locations-en.csv", "GeoLite2-City-Blocks-IPv4.csv");
